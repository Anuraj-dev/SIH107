...
Conversational assistant per `docs/product-brief.md`. Retrieval uses allowlisted BIS
metadata and the checked-in BIS gazette/product-manual corpus. Paid full-standard text
is excluded.
